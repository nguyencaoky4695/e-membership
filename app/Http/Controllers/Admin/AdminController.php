...
class AdminController extends Controller
{
    ...
    public function Postadduser(Request $request)
    {
        ...
        if($request->hasFile('image')){
            ...
            $filedata = $request->file('image')->getPathname();
            ...
            $img = $request->file('image')->move($path , $hinh);
      ...
      if (function_exists('curl_file_create')) { 
        ...
        $data['avatar'] = $cFile;
        dd($data);
        $url = \App\connect::url().'/users/register';
        $thongbao = \App\connect::sendPostData($url,$data);
        dd($thongbao);
    }
