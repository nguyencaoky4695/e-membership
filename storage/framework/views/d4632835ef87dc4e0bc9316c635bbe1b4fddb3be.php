...
<footer>
    <div class="container text-center">
        <h1>WINE CENTER</h1>
        <i>"Chúng tôi khao khát không chỉ mang đến cho khách hàng không chỉ thứ đồ uống thượng hạn của thế giới văn minh,<br/> mà tuyệt vời hơn là
            văn hóa và nghệ thuật thưởng thức"</i>
        <div class="space"></div>
        <ul class="list-inline banner-social-buttons">
            <li>
            ...
            <li>
                <a href="https://plus.google.com/+Startbootstrap/posts" class="btn btn-default btn-lg"><i class="fa fa-google-plus fa-fw"></i> <span class="network-name"></span></a>
            </li>
        </ul>
        <div class="space"></div>
